...
const BookReturnTable = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://localhost:3000/api/booksToreturned');
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                try {
                    ...
                    const response = await fetch(`http://localhost:3000/api/returned_book/${selectedActivity.activity_id}`, {
                        method: 'PUT',
                        headers: {
                    ...
                    if (response.ok) {
                        ...
                        const increaseResponse = await fetch(`http://localhost:3000/api/books_increase/${selectedActivity.book_id}`, {
                            method: 'PUT',
                            headers: {
                                'Content-Type': 'application/json',
                            },
